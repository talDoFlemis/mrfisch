    ...
    <div id="create" className="relative w-full h-screen text-white">
      ...
      <div className="relative z-10 p-4 h-full text-center bg-gradient-to-t via-transparent from-black/90 to-black/90">
        <div className="grid grid-rows-2 gap-x-8 gap-y-8 place-content-center place-items-center mx-auto h-full md:grid-cols-2 md:grid-rows-none 2xl:container">
          <div className="relative row-start-2 self-start w-full sm:w-full md:row-auto md:self-auto xl:w-3/4 group">
            <div className="absolute -inset-0.5 bg-gradient-to-r rounded-xl opacity-70 transition-opacity duration-1000 group-hover:opacity-100 group-hover:duration-300 animate-tilt from-accent via-accent to-primary blur-lg"></div>
          ...
          <div className="flex flex-col gap-y-5 self-end md:self-auto">
            <div className="text-3xl font-bold sm:text-5xl 2xl:text-6xl font-raleway">
              Create code with{" "}
